...
urlpatterns = [
    ...
    path('request-password-reset-email/', views.RequestPasswordResetEmailView.as_view(),
         name='request-password-reset-email'),
    path('password-reset/<uidb64>/<token>/', views.PasswordResetTokenValidationView.as_view(),
